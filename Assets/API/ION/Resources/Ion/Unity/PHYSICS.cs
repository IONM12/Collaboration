...
namespace Ion
{
	public static class PHYSICS
	{
		...
		//====================================================================================================
		static public RAYCASTHIT Raycast(RAY ray)
		{
			Ray r = ray;
			RaycastHit raycastHit;

			bool hit = UnityEngine.Physics.Raycast(r, out raycastHit);

			return new RAYCASTHIT(hit, raycastHit);
		}
		//====================================================================================================
		static public RAYCASTHIT Raycast(RAY ray, int layerMask)
		{
			Ray r = ray;
			RaycastHit raycastHit;
			...
			bool hit = UnityEngine.Physics.Raycast(r, out raycastHit, distance, layerMask);
